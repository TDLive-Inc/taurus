...
<html>
	...
	<body>
		<center><p align="center" style="font-family: ' . "'Bubblegum Sans'" . ', cursive;"><h1><img src="http://placehold.it/350x150&text=Taurus"></h1><b><i>' . constant("TAURUS_MOTTO") . '</i></b></p><h2>' . constant("TAURUS_LOG_IN") . '</h2><br>';
		if(isset($error)) {
